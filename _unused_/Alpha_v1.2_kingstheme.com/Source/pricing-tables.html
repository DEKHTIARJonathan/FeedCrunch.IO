...
<html lang="en">
    <head>
        ...
        <link href="assets/plugins/pricing-tables/css/style.css" rel="stylesheet">      
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="pricing-tables.html" class="active-page">Pricing Tables</a></li>
            ...
            <div class="page-footer">
                <div class="footer-grid container">
                    ...
                    <div class="footer-grid-l white">
                        <a class="footer-text" href="forgot.html">
                    ...
                    <div class="footer-grid-r white">
                        <a class="footer-text" href="contact.html">
