 ...
 * ===================================================
 * Copyright 2012 Max Favilli modified by Jonathan DEKHTIAR https://www.jonathandekhtiar.eu
 *
...
(function($) {
	...
	publicMethods = {
		...
		pushTag : function (tag, ignoreEvents, externalTagId, parseMultiple) {
			...
			} else if (opts.CapitalizeFirstLetterOnly && tag.length > 1) {
			...
			this.each(function() {
				...
				if (opts.output === null) {
					...
					$self.after(hiddenObj);
						...
						hiddenObj = $('#'+opts.hiddenTagListId);
					}
