    ...
    <body>
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="timeline.html" class="active-page">Timeline</a></li>
		...
		<div class="cd-timeline-block">
			<div class="cd-timeline-img cd-picture">
				<img src="assets/plugins/vertical-timeline/img/cd-icon-picture.svg" alt="Picture">
			</div> <!-- cd-timeline-img -->

			<div class="cd-timeline-content">
				<h2>Title of section 1</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut.</p>
				<a href="#0" class="waves-effect waves-blue btn-flat">Read more</a>
		...
		<div class="cd-timeline-block">
			<div class="cd-timeline-img cd-movie">
				<img src="assets/plugins/vertical-timeline/img/cd-icon-movie.svg" alt="Movie">
			</div> <!-- cd-timeline-img -->
		...
		<div class="cd-timeline-block">
			<div class="cd-timeline-img cd-location">
				<img src="assets/plugins/vertical-timeline/img/cd-icon-location.svg" alt="Location">
			</div> <!-- cd-timeline-img -->
            ...
            <div class="page-footer">
                <div class="footer-grid container">
                    ...
                    <div class="footer-grid-l white">
                        <a class="footer-text" href="gallery.html">
                    ...
                    <div class="footer-grid-r white">
                        <a class="footer-text" href="calendar.html">
