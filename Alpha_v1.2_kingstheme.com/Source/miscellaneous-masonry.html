...
<html lang="en">
    <head>
        ...
        <link href="assets/plugins/codemirror/theme/material.css" rel="stylesheet" type="text/css"/>       
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active">
                        <a class="collapsible-header waves-effect waves-grey active"><i class="material-icons">star_border</i>Plugins<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="miscellaneous-masonry.html" class="active-page">Masonry</a>
                                <li><a href="miscellaneous-idle-timer.html">Idle Timer</a>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding active">
                        <a class="collapsible-header waves-effect waves-grey active"><i class="material-icons">star_border</i>Miscellaneous<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="miscellaneous-sweetalert.html">Sweet Alert</a>
                                <li><a href="miscellaneous-code-editor.html">Code Editor</a>
                                <li><a href="miscellaneous-sweetalert.html">Nestable List</a>
                                <li><a href="miscellaneous-sweetalert.html">Toastr</a>
                                <li><a href="miscellaneous-sweetalert.html">i18</a>
                                <li><a href="miscellaneous-sweetalert.html">Tree View</a>
                                <li><a href="miscellaneous-sweetalert.html">CSS Animations</a>
                                <li><a href="miscellaneous-masonry.html" class="active-page">Masonry</a>
                                <li><a href="miscellaneous-sweetalert.html">Session Timeout</a>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Masonry</div>
                    </div>
                    <div class="col s12">
                        <div class="grid" >
                            <div class="grid-item">
                                <div class="card">
                                    <div class="card-content">
                                        <span class="card-title">Example masonary box</span>
        ...
        <script src="assets/js/pages/miscellaneous-masonry.js"></script>
