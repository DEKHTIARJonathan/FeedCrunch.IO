    ...
    <body>
        ...
        <div class="mn-content">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        <section class="material-design-hamburger navigation-toggle">
                            <a href="#" data-activates="slide-out" class="button-collapse right-sidebar-button show-on-large material-design-hamburger__icon">
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="layout-right-sidebar.html" class="active-page">Right Sidebar</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
            ...
            <main class="mn-inner container">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Right Sidebar</div>
                    </div>
                </div>
            </main>
        ...
        <div class="left-sidebar-hover right-sidebar"></div>
