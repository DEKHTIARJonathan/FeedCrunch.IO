    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active">
                        <a class="collapsible-header waves-effect waves-grey active"><i class="material-icons">mode_edit</i>Forms<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="form-select2.html" class="active-page">Select2</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Select2</div>
                    </div>
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Basic</span>
                                <p>Select2 can take a regular select box and turn it into this...</p><br>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Limiting the number of selections</span>
                                <p>Select2 multi-value select boxes can set restrictions regarding the maximum number of options selected. The select below is declared with the <code>multiple</code> attribute with <code>maxSelectionLength</code> in the select2 options.</p><br>
                                <select class="js-example-basic-multiple-limit js-states browser-default" multiple="multiple" tabindex="-1" style="width: 100%" id="limited">
                                    <optgroup label="Alaskan/Hawaiian Time Zone">
                                        <option value="AK">Alaska</option>
                                        <option value="HI">Hawaii</option>
                                    </optgroup>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Automatic tokenization</span>
                                <p>Select2 supports ability to add choices automatically as the user is typing into the search field. Try typing in the search field below and entering a space or a comma.</p><br>
                                <select class="js-example-tokenizer js-states browser-default" multiple="multiple" tabindex="-1" style="width: 100%" id="tokenizer">
                                    <optgroup label="Alaskan/Hawaiian Time Zone">
                                        <option value="AK">Alaska</option>
                                        <option value="HI">Hawaii</option>
                                    </optgroup>
                                ...
                                </select><p><br>The separators that should be used when tokenizing can be specified using the <code>tokenSeparators</code> options.</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Loading array data</span>
                                <p>Select2 provides a way to load the data from a local array.</p><br>
                                <select class="js-example-data-array js-states browser-default" tabindex="-1" style="width: 100%" id="array"></select>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-footer">
                <div class="footer-grid container">
                    ...
                    <div class="footer-grid-l white">
                        <a class="footer-text" href="form-image-zoom.html">
                    ...
                    <div class="footer-grid-r white">
                        <a class="footer-text" href="table-static.html">
