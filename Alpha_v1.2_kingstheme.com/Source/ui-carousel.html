            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active">
                        <a class="collapsible-header waves-effect waves-grey active"><i class="material-icons">code</i>Components<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="ui-carousel.html" class="active-page">Carousel</a></li>
            ...
            <div class="page-footer">
                <div class="footer-grid container">
                    ...
                    <div class="footer-grid-l white">
                        <a class="footer-text" href="ui-cards.html">
                    ...
                    <div class="footer-grid-r white">
                        <a class="footer-text" href="ui-chips.html">
