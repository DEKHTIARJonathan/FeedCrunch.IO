    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="form-input-mask.html" class="active-page">Input Mask</a></li>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Input Mask</div>
                    </div>
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content">
                                <p>jquery.inputmask is a jquery plugin which create an input mask. An inputmask helps the user with the input by ensuring a predefined format. This can be usefull for dates, numerics, phone numbers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Example</span><br>
                                <div class="row">
                                    <form class="col s12">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="" id="mask1" class="masked" type="text" data-inputmask="'alias': 'date'">
                                                <label for="mask1" class="active">Date</label>
                                            </div>
                                            <div class="input-field col s12">
                                                <input placeholder="" id="mask2" class="masked" type="text" data-inputmask="'mask': 'y/m/d'">
                                                <label for="mask2" class="active">Date Alt</label>
                                            </div>
                                            <div class="input-field col s12">
                                            ...
                                            <div class="input-field col s12">
                                                <input placeholder="" id="mask5" class="masked" type="text" data-inputmask="'numericInput': true, 'mask': '$ 999,999.99', 'rightAlignNumerics':false">
                                                <label for="mask5" class="active">Currency</label>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <pre>&lt;div class="input-field col s12">
     &lt;input placeholder="" id="mask1" class="masked" type="text" data-inputmask="'alias': 'date'">
     &lt;label for="mask1" class="active">Date&lt;/label>
&lt;/div>
&lt;div class="input-field col s12">
